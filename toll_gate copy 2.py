...
def draw_dashboard(canvas, cam_width):
    ...
    lines = [
        ...
        (f"Total: {stats['total']}", (255, 255, 255)),
        (f"Approved: {stats['approved']}", (0, 255, 0)),
        (f"Rejected: {stats['rejected']}", (0, 0, 255)),
        (f"Camera: {current_camera_index}", (255, 255, 255)),
        ("Switch cam: 0 / 1 / 2", (180, 180, 180)),
    ]
...
print("System started. Available cameras:", AVAILABLE_CAMERAS)
